...
(* OASIS_START *)
(* DO NOT EDIT (digest: 362662e86b03a6745249ad75e2630713) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "comm_tests.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_digest =
       Some
         "\173\129\179\237\228\215\155\151\017\165\245\253\190\177\152\159";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
