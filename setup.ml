...
(* OASIS_START *)
(* DO NOT EDIT (digest: 579f66a526d1127808c47e9427c18c0e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Lwt library used to implement typed bidirectional servers within process, and extend them to tcp/ip servers";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "linenum_server.ml"});
               Executable
                 ({
                     cs_name = "linenum_client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "linenum_client.ml"});
               Executable
                 ({
                     cs_name = "test_shutdown";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_shutdown.ml"});
               Executable
                 ({
                     cs_name = "fail_before_ack";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "fail_before_ack.ml"});
               Executable
                 ({
                     cs_name = "reconnect_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "reconnect_test.ml"});
               Executable
                 ({
                     cs_name = "misc_tests";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "misc_tests.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\006\002T\163\129\186n\234\234\157\128\174\005x\162\245";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
